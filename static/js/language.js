...
const translations = {
  en: {
    ...
    welcome_message: "🌱 Welcome to Pechay Detection System!",
    ...
    create_dataset: "➕ Create Petchay Dataset",
    upload_new_image: "📷 Upload New Image",
    view_results: "📝 View Results",
    
    // Upload Page
    scan_pechay_leaf: "📸 Scan Petchay Leaf",
    ...
    end_date: "End Date:",
    generate_view_report: "🖨️ Generate & View Report",
    ...
    // Camera/Stream
    esp32_cam_live_view: "📹 ESP32-CAM Live View",
  ...
  tl: {
    ...
    filter_by_time: "📅 I-filter ayon sa saklaw ng oras:",
    ...
    // Analytics Page
    analytics_reports: "📈 Analytics at Mga Report",
    ...
    generate_view_report: "🖨️ Gumawa at Tingnan ang Report",
    ...
    change_password_btn: "🔑 Palitan ang Password",
    session_management: "🚪 Pamamahala ng Sesyon",
    ...
    start_stream: "▶️ Simulan ang Stream",
    stop: "⏹️ Itigil",
    ...
    recent_detections: "📋 Kamakailang Mga Detection",
    no_detection_records: "Walang nakitang record ng detection.",
    back_to_dashboard: "⬅️ Bumalik sa Dashboard",
    print_report: "🖨️ I-print ang Report",
  ...
  war: {
    ...
    // Dashboard
    dashboard_overview: "📊 Pangkalahatan nga Dashboard",
    ...
    diseased_percent: "may sakit",
    create_dataset: "➕ Maghimo hin Petchay Dataset",
    upload_new_image: "📷 Mag-upload hin Bag-o nga Ladawan",
    view_results: "📝 Tan-awa an Mga Resulta",
    
    // Upload Page
    scan_pechay_leaf: "📸 I-scan an Petchay Leaf",
    ...
    // Results Page
    detection_results: "📝 Mga Resulta han Detection",
    filter_by_time: "📅 I-filter sumala ha saklaw han oras:",
    ...
    generate_report: "📄 Maghimo hin Report",
    ...
    generate_view_report: "🖨️ Maghimo ngan Tan-awa an Report",
    failed_load_analytics: "Nabigo na i-load an analytics data. Pakisubayi liwat.",
    
    // Settings Page
    language_settings: "🌐 Mga Setting han Pinulungan",
    select_language: "Pili hin Pinulungan:",
    profile_settings: "👤 Mga Setting han Profile",
    username_label: "Ngaran han Gumaramit:",
    username_immutable: "Diri maililiwat an Username",
    email_label: "Email:",
    update_profile: "💾 I-update an Profile",
    change_password: "🔒 Liwat hin Password",
    ...
    recent_detections: "📋 Kamakailan nga Mga Detection",
    no_detection_records: "Waray nakitang record han detection.",
    back_to_dashboard: "⬅️ Bumalik ha Dashboard",
    print_report: "🖨️ I-print an Report",
    download_excel: "📥 I-download an Excel",
